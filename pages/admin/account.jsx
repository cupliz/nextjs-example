...
export default function account() {
  ...
  const checkProvider = (key) => {
    if (key === "google.com") {
      return (
        <button
          className="bg-red-500 rounded-lg py-1 px-2 text-white flex items-center"
          disabled
        >
          <IoLogoGoogle /> &nbsp; Google
        </button>
  ...
  const { providerId, photoURL, displayName, email, phoneNumber } =
        ...
        <div className="col-span-3">
          <div className="drop-shadow-lg bg-gray-50 rounded p-4 md:p-5 mt-10 md:mt-0 space-y-5 border border-gray-200">
            ...
            <div className="flex items-center">
              ...
              <input
                className="form-input border-none rounded bg-gray-100"
                type="text"
                disabled
                value={displayName || ""}
              />
